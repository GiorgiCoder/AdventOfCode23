...
namespace AdventOfCode.AdventOfCode2023.Day17
{
    internal class Part1
    {
        ...
        // rowIndex, colIndex, direction, steps, priority
        ...
        static void main(string[] args)
        {
            ...
            Console.WriteLine(Visited[maxX][maxY].Min(x => x.Value));
        }
        ...
        private static void Move(int x, int y, int direction, int heat, int steps)
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                ...
                if (newX < 0 || newX >= Visited.Length || newY < 0 || newY >= Visited[0].Length || newDirectionMoves > 3)
                    return;
